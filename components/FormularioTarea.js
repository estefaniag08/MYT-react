      ...
      {(formik) => {
        return (
          <Form>
            <div
              class="contenido"
              className={`${styles.contenido_creartarea} grid grid-cols-1  text-center`}
            >
              <h1
                className={`${styles.h1} text-4xl text-center col-span-4 inset-1/2`}
              >
                {" "}
                información general tarea
              </h1>
              ...
              <h1
                className={`${styles.h1} pt-4 text-4xl  col-span-4 inset-1/2`}
              >
                {" "}
                Entrega
              </h1>
              ...
              <div className="grid grid-cols-2 gap-5 items-center text-2xl sm:text-3xl">
                <h3 className=" text-black text-right ">
                  Seleccionar tarea general:
                </h3>
                <input
                  type="text"
                  className="bg-white text-xl h-6 w-24 sm:h-8"
