    ...
    return (
        <div class="modal_sidebar" className={`${styles.modal_sidebar}`}>
            <div class="contenedor_sidebar" className={`${styles.contenedor_sidebar} font-bold flex flex-col text-5xl`}>                      
                ...
                <Link href="/">
                    <div className="bg-[#F8F8F9] opacity-90 inset-x-0 mb-1 mx-1 h-20 hover:cursor-pointer flex items-center justify-center absolute bottom-0">
                        <h1 className=" text-center text-[#4A4A4A]">cerrar sesión</h1>
                    </div>  
                </Link>
            </div>            
        </div> 
